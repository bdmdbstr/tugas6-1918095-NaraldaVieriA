package com.example.aplikasiworkmanager;
...
import com.example.aplikasiworkmanager.databinding.ActivityMainBinding;
        ...
        mainBinding.appCompatButtonStart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mainBinding.appCompatButtonStart.getText().toString().equalsIgnoreCase(getString(R.string.button_text_start))) {
                    // START Worker
                    PeriodicWorkRequest periodicWork = new PeriodicWorkRequest.Builder(MyWorker.class, 5, TimeUnit.MINUTES)
                            .addTag(TAG)
                            .build();
